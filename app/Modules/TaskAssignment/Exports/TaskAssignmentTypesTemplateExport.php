...
/**
 * Export file mẫu để người dùng tải về và điền dữ liệu loại văn bản trước khi import.
 *
 * Cấu trúc file:
 ...
 */
class TaskAssignmentTypesTemplateExport implements FromArray, WithHeadings, WithStyles, WithColumnWidths, WithTitle
{
    /**
    ...
    {
        return [
            ['Văn bản 1', 'Các Văn bản thuộc lĩnh vực chuyên môn', 'active'],
            ['Văn bản 2', 'Văn bản phát sinh ngoài kế hoạch', 'active'],
        ];
    }

    /**
     * Hàng tiêu đề — WithHeadingRow sẽ normalize thành key để map trong Import class.
     * "Tên loại văn bản (*)" → ten_loai_cong_viec
     * "Mô tả"                  → mo_ta
